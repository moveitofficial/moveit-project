...
import { EXPERT_ERRORS, SERVICE_ERRORS } from '../common/constants/errors';
...
export class ServicesService {
  ...
  async createService(
    ...
    if (!expertProfile) throw new AppException(EXPERT_ERRORS.NOT_FOUND);
    if (!expertProfile.isApproved)
      throw new AppException(EXPERT_ERRORS.NOT_APPROVED);
