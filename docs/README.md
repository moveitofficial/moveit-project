...
| Figma 디자인 노드 찾기 (화면 → nodeId) | [frontend-figma-references.md](frontend-figma-references.md) |
| 웹 API 명세 / 백엔드 구현 요청 사항 | [api-spec-web.md](api-spec-web.md) |
...
- **[frontend-figma-references.md](frontend-figma-references.md)** — apps/web · apps/admin 화면별 Figma nodeId 매핑 카탈로그. 새 디자인 받으면 여기에 한 줄 추가.
- **[api-spec-web.md](api-spec-web.md)** — apps/web 전체 API 명세. 18개 도메인, 공통 응답·인증·enum·디자인 매핑·구현 상태 포함. 백엔드 공유용.
